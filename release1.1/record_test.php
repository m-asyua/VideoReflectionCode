...
<body>
    ...
    <input type="hidden" value="$start_flg" id="start_flg" > 
    <input type="hidden" value="$timer" id="set_timer" > 
    <!--                        ^^^^^^  $timer is here     -->
    
    <input type="text" value="" id="timer" > 
    <span id="status" ><font color="#ff0000">[-----]</font></span>
    <input type="button"  value="Start record"            id="start_button" >
    <input type="button"  value="Stop  record"            id="stop_button" disabled  >
    <br>
    <table border="1">
        <tr>
        <td>
